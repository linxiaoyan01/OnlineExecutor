...
public class JavaClassExecutor {
    ...
    public static String execute(byte[] classByte, String systemIn) {
        ...
        byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System","top/kaluna/OnlineExecutor/execute/HackSystem");
        modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "top/kaluna/OnlineExecutor/execute/HackScanner");
