package top.kaluna.OnlineExecutor.compile;
...
public class StringSourceCompiler {
    ...
    public static class TmpJavaFileObject extends SimpleJavaFileObject{
         ...
         * 需要传入源码 source 然后调用父类的构造方法创建 kind = Kind.SOURCE 的JavaFileObject对学校
         * @param name
         * @param source
         */
         ...
         * 需要传入源码kind，即我们想要构建一个存储什么类型文件的JavaFileObject
         */
